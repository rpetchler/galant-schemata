...
upVoice = \new Voice {
  \relative c' {
    \repeat volta 2 {
      ...
      a16 \mdo e8. \stopGroup <fis d>8 \tweak HorizontalBracket.shorten-pair #'(0 . -3) \converginghc [ <e cis> ] <e cis> [ <d b> ] <d b> [ <cis a> ] |
      ...
      a8 \tweak HorizontalBracket.shorten-pair #'(0 . -4.5) \authenticCadence \f cis16 e a8 a \grace { b16 } a32 gis a8. \grace { b16 } a32 gis a8. |
      ...
      <d' gis,>8 r <cis a> r r4 \tweak HorizontalBracket.shorten-pair #'(0 . -3) \authenticCadence <a e cis a> |
      <fis d a>4 r8 <fis d> <e cis> <d b> <cis a> <b gis> |
      a4 r \stopGroup r <e' cis>8 \p r |
    ...
    \repeat volta 2 {
      ...
      e8. fis16 e2 a8 -. \tweak HorizontalBracket.shorten-pair #'(-7.5 . 0) \authenticCadence cis,8 -. |
      \grace { cis8 } b4 a2 \grace { cis16 } b8 a16 gis |
      a16 \f a' a, a' \stopGroup a, a' a, a' a, a' a, a' a, a' a, a' |
      ...
      d4 cis16 \authenticCadence \tweak HorizontalBracket.shorten-pair #'(-4.5 . 0) \cudworth b a g fis4 e |
      d4 \stopGroup <d a fis> <d a fis> \stopGroup r |
      ...
      d16 \mdo a8. \stopGroup <b g>8 \tweak HorizontalBracket.shorten-pair #'(0 . -3) \converginghc [ <a fis> ] <a fis> [ <g e> ] <g e> [ <fis d> ] |
...
downVoice = \new Voice {
  \relative c {
    ...
    \repeat volta 2 {
      ...
      cis,8 a' e a cis, \bmi a' e a |
      d,8 \bfa b' fis b e, \bso b' gis b |
      a,4 \bdo a'8. g!16 fis4 fis8. e16 |
      ...
      b4 g \bfa a \bso \stemUp a, \bso |
      \stemDown d4 \bdo \stemUp d, d r |
